	...
	<div class="wrap">
		<div class="content-top" style="min-height:300px;padding:50px">
			<div class="col-md-4 col-md-offset-4">
				...
				<p class="login-box-msg">Haz LogIn para comenzar tu proceso</p>
      ...
      <div class="form-group">
          ...
          <p class="login-box-msg" style="padding-top:20px">Nuevo Aqui? <a href="registration.php">Registrate</a></p>
      </div>
      </div>
</div>
    </form>
